...
public class PlayPauseDrawable extends Drawable {
    ...
    private void toggle() {
        ...
        // Reckoning the Animation whether pause or play do accordingly
        animator = ObjectAnimator.ofFloat(this, PROGRESS, isPlay ? 1.0F : 0.0F, isPlay ? 0.0F : 1.0F);
        animator.addListener(new AnimatorListenerAdapter() {
            @Override
            public void onAnimationEnd(Animator animation) {
                // if video is playing then it gonna pause
                // and if its paused then it gonna play from that time
                isPlay = !isPlay;
            }
        });
